...
for year in ['2007', '2012']:
  for split in ['train', 'val', 'trainval', 'test']:
      for weather in ['daytimeclear','daytimefoggy', 'duskrainy', 'nightrainy',
       'nightclear','citysource', 'citytarget', 'day1', 'day2', 'day3', 'clipart', 'watercolor']:
        name = 'voc_{}_{}_{}'.format(year, split, weather)
        __sets[name] = (lambda split=split, year=year, weather=weather: pascal_voc(split, year, weather))
