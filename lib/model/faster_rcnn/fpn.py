...
from model.roi_layers import ROIAlignfpn, ROIPool

from model.rpn_fpn.proposal_target_layer import _ProposalTargetLayer
...
class _FPN(nn.Module):
    ...
    def __init__(self, classes, class_agnostic):
        ...
        self.RCNN_roi_align = ROIAlignfpn((cfg.POOLING_SIZE, cfg.POOLING_SIZE), 1.0 / 16.0, 0)
